...
class Upload{
	...
	/**
	 * 单文件上传
	 * @param array $file，上传的图片信息（5个）
	 * @param array $allow，允许上传的文件的MIME类型
	 * @param int $max，允许上传文件的最大限制
