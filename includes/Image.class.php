<?php
	...
	class Image{
		...
		*/
		...
		/**
		 * 创建水印图
		 * @param string $file，要创建水印的图片
		 * @param int $position，水印图的位置，默认是5，表示右下角 
		 * @param int $pct，透明度，默认为30 
		 * @param string $water，水印图片，默认值为空，读配置文件
